...
//
// Runs an arbitrary user-supplied async script body inside OneNote.run. The
// body receives `context` (the RequestContext) and `args` (the user-supplied
// scriptArgs). It must `return` a JSON-serializable value.
