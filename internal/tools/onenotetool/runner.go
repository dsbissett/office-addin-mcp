// Package onenotetool registers onenote.* tools backed by Office.js payloads
// embedded in internal/js. OneNote payloads dispatch through __runOneNote,
// which wraps OneNote.run.
package onenotetool
...
func runPayloadSum(ctx context.Context, env *tools.RunEnv, sel tools.TargetSelector, payload string, args any, summaryFn func(any) string) tools.Result {
	return officetool.RunPayload(ctx, env, sel, payload, args, summaryFn, "OneNote")
}
